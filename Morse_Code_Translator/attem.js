...
let regularText = document.getElementById("regularText");
let intoMorse = document.getElementById("intoMorse");
let m = Object.create(MorseCode);

regularText.addEventListener("input", function(){
    intoMorse.value = m.encode(regularText.value);
});

intoMorse.addEventListener("input", function(){
    regularText.value = m.decode(intoMorse.value);
});